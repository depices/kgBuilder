...
<template>
  <div class="mind-box">
    ...
    <div class="mind-con">
      ...
      <div class="mind-top clearfix">
        ...
        <div class="fr">
          ...
          <a href="javascript:void(0)" @click="openGxcq" class="svg-a-sm">
             <i class="el-icon-tickets">关系抽取</i>
          </a>

          <a href="javascript:void(0)" @click="openZdtq" class="svg-a-sm">
            <i class="el-icon-tickets">自动抽取</i>
          </a>
    ...
    <div>
      <kg-gxcq ref="kg_gxcq"></kg-gxcq>
    </div>
    <div>
      <kg-zdtq ref="kg_zdtq"></kg-zdtq>
    </div>
  </div>
</template>
<script>
...
import KgGxcq from "@/components/KGgxcq";
import KgZdtq from "@/components/KGzdtq.vue"
...
export default {
  ...
  methods: {
    ...
    openGxcq() {
      this.$refs.kg_gxcq.init();
    },
    openZdtq(){
      this.$refs.kg_zdtq.init();
    },
    //导入图谱
    importGraph() {
